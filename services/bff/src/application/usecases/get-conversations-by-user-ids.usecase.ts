...
import { type ConversationOutput, type GetConversationsByUserIdsDto } from '../dtos';
...
export class GetConversationsByUserIdsUseCase implements GetConversationsByUserIdsInput {
  ...
  async execute(input: GetConversationsByUserIdsDto): Promise<Map<string, ConversationOutput[]>> {
